...
class CanvasRecorder {
    close() {
        this.uiDiv && document.body.removeChild(this.uiDiv);
        this.uiDiv = null
    }
...
`
        ...
        closeButton.onclick = ()=>{
            (closeButton.innerText = (video.style.display !== '' ? str_close : str_open)) && (video.style.display = (video.style.display === '' ? 'none' : ''))
        }
...
//let audioDestination = self.audioContext.createMediaStreamDestination()
//self.audioContext && (audioSource = self.audioContext.createMediaStreamSource(audioContext.destination.stream));
//stream.addTrack(audioSource.getAudioTracks()[0])
        ...
        function startRecording() {
            ...
            recordButton.textContent = str_stop;
            //'Stop Recording';
