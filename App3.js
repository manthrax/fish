...
export default class App3 {
    constructor() {
       ...
       // document.body.style.zIndex = c.style.zIndex = -1;
...
App3.loadPhaseComplete=(count=1)=>{
    ...
    if(loadPhase==0){
        ...
        let m = App3.fadePlane = new THREE.Mesh(new THREE.PlaneGeometry(1,1),new THREE.MeshBasicMaterial({color:'black',side:THREE.DoubleSide,transparent:true,opacity:1}))
